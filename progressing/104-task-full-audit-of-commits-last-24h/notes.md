# Audit Findings
- Found "tasks-ai" branding artifacts in `install.sh`, `tasks_ai/cli.py`, `bug-report.md`, and `tests/tasks_ai/cli.py`.
...
# Plan
1. Systematically rename `tasks-ai` to `hammer` in paths, file naming, and docs.
